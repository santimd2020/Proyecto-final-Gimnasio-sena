...
export class DietashomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dieta.getRequestAllDietas('https://proyectofinalsena.herokuapp.com/consultarDietas', localStorage.getItem('token'))
      .subscribe(
        (data): any => {
  ...
  eliminarDietaPorId(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.dieta.deleteDietas('https://proyectofinalsena.herokuapp.com/eliminarDietas/' + id, localStorage.getItem('token'))
          .subscribe(
            (data): any => {
              console.log(data)
              this.load = true;
  ...
  GenerarReporte() {
    this.dieta.getReporteAllDietas('https://proyectofinalsena.herokuapp.com/reporteDietas', localStorage.getItem('token'))
      .subscribe(
        (data): any => {
          console.log(data)
    ...
    Swal.fire({
      ...
      .then(resultado => {
        if (resultado.value) {
          ...
          let url: string = `https://proyectofinalsena.herokuapp.com/asignarDieta/${id}/${identificacion}`;
